		...
		<div>
			...
			<main>
				<section id='welcome' className='welcome'>
					...
					<Row className='header my-3 p-3 mb-0 pb-0'>
						<Col xs={12} md={12} lg={8} xxl={8}>
							<h1>Defi Punks</h1>
							<p className='sub-header'>Disponível em 25 / 09 / 22</p>
						</Col>
						<Col className='flex social-icons'>
							...
							<a
								href="https://www.instagram.com/proffernandolopes/"
								target='_blank'
								className='circle flex button'>
					...
					<Row className='flex m-3'>
						<Col md={5} lg={4} xl={5} xxl={4} className='text-center'>
							<img
								src={`https://gateway.pinata.cloud/ipfs/Qmeszxf2QdE1sNe31vk2nkUWFyt5J5GuTxXniBJxwB1BmZ/${counter}.png`}
								alt="Defi University Punk"
								className='showcase'
							/>
						</Col>
						<Col md={5} lg={4} xl={5} xxl={4}>
							...
							<p className='text'>
								Em pleno 2022, ano da copa do mundo, a DeFi University te presenteia com mais esta obra prima da web3.
								Vocês conhecem o Elon Musk? Está construindo um foguete.
							</p>
				...
				<section id='about' className='about'>
					...
					<Row className='flex m-3'>
						<h2 className='text-center p-3'>Sobre a Coleção</h2>
						<Col md={5} lg={4} xl={5} xxl={4} className='text-center'>
						...
						<Col md={5} lg={4} xl={5} xxl={4}>
							{isError ? (
								...
								<div>
									...
									<ul>
										<li>25 generated punked out images usando um art generator</li>
										<li>Free minting na göerli testnet</li>
										<li>Veja no Opensea logo após o minting</li>
									</ul>
